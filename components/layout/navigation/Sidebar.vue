						...
						<DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
							...
							>
								<div class="absolute left-full top-0 flex w-16 justify-center pt-5">
									<button
										class="-m-2.5 p-2.5 focus-visible:focus-util hover:bg-base-0/20 rounded-md"
										type="button"
									...
									>
										...
										<XMarkIcon
											aria-hidden="true"
											class="h-6 w-6 text-base-content-highlight hover:text-base-content-hover"
										/>
									</button>
								</div>
							</TransitionChild>
							...
							<div class="flex grow flex-col gap-y-6 overflow-y-auto bg-base-1000 px-6 ring-1 ring-base-0/10">
								<!-- Logo -->
								<div class="flex flex-col shrink-0 gap-y-2 pt-2 items-center">
									<img
										alt="Logo"
										class="h-64 w-full"
										height="512"
								...
								<nav class="flex flex-1 flex-col">
									...
									>
										...
										>
											<NuxtLink
												:href="item.href"
												class="focus-visible:focus-util group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold hover:text-base-content-hover hover:bg-base-0/20"
										...
										<li class="-mx-2 space-y-1">
											<NuxtLink
												class="focus-visible:focus-util group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold text-gray-400 hover:text-base-content-highlight hover:bg-base-0/20 underline underline-offset-8 decoration-primary-500 decoration-2"
												exactActiveClass="bg-base-0/20 text-base-content-highlight"
												href="/premium"
											>
												<SparklesIcon
										...
										<li class="flex-1 flex flex-col">
											...
											<div class="flex justify-around pb-3">
												<!-- Twitter -->
												<NuxtLink
													class="focus-visible:focus-util group flex flex-col items-center gap-2 rounded-md p-2 text-sm font-semibold text-gray-400 hover:text-base-content-highlight hover:bg-base-0/20"
